...
const Dock = () => {
  ...
  return (
    ...
    >
      ...
      <DockItem mouseX={mouseX} icon={Mail} label="Contact" onClick={() => window.location.href = 'mailto:test@test.com'} />
    </div>
  );
};

// --- 3. PROJECT PREVIEW HOVER ---
const ProjectList = () => {
  ...
  const projects = [
    { id: 1, title: "Fintech Dashboard", category: "React / D3", color: "from-blue-500 to-cyan-500" },
    { id: 2, title: "AI Image Engine", category: "Python / WebGL", color: "from-purple-500 to-pink-500" },
    { id: 3, title: "E-Commerce Core", category: "Next.js / Rust", color: "from-orange-500 to-red-500" },
    { id: 4, title: "Spatial Audio", category: "Three.js", color: "from-green-500 to-emerald-500" },
  ];
      ...
      <header className="relative z-10 max-w-5xl mx-auto px-6 pt-32 pb-24">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/50 max-w-2xl leading-relaxed">
            Design Engineer crafting <span className="text-white">high-performance</span> interfaces 
            with a focus on motion, depth, and typography.
          </p>
          
          <div className="flex gap-4 pt-4">
            <button className="cursor-pointer px-6 py-3 rounded-lg bg-white text-black font-medium hover:bg-gray-200 transition-colors">
               Contact Me
            </button>
            <button className="cursor-pointer px-6 py-3 rounded-lg border border-white/10 hover:bg-white/5 transition-colors">
               Read Blog
            </button>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-auto md:h-[500px]">
            <BentoItem className="md:col-span-2 md:row-span-2 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mb-4">The Bridge Between Design & Code</h3>
                <p className="text-white/50 leading-relaxed">
                  I don't just write code; I build systems. My background in architectural design allows me 
                  to think spatially about user interfaces. I specialize in React ecosystems, performant 
                  animations, and scalable backend logic.
                </p>
              </div>
              <div className="mt-8 flex gap-2">
                 {['React', 'Next.js', 'Typescript', 'Node', 'Rust'].map(tag => (
                   <span key={tag} className="px-3 py-1 rounded-full border border-white/10 bg-white/5 text-xs text-white/40">{tag}</span>
                 ))}
              </div>
            </BentoItem>
            ...
            <BentoItem className="md:col-span-1">
               <div className="h-full flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-white/40">Remote / GMT-5</span>
                  </div>
               </div>
            </BentoItem>
          </div>
        ...
        <section id="stack" className="grid grid-cols-1 md:grid-cols-2 gap-12">
           <div>
             ...
             <div className="space-y-8 border-l border-white/10 pl-8 ml-3">
               {[
                 { company: "Vercel", role: "Senior Engineer", date: "2023 - Present" },
                 { company: "Linear", role: "Product Engineer", date: "2021 - 2023" },
                 { company: "Shopify", role: "Frontend Dev", date: "2019 - 2021" },
               ].map((job, i) => (
                 <div key={i} className="relative">
                   ...
                   <p className="text-white/50 mb-1">{job.role}</p>
                   <p className="text-xs font-mono text-white/30">{job.date}</p>
                 </div>
               ))}
             </div>
           </div>
           ...
           <div>
              <div className="p-8 rounded-2xl border border-white/10 bg-white/[0.02]">
                 ...
                 <a href="mailto:hello@alex.com" className="cursor-pointer inline-flex items-center gap-2 text-white border-b border-white pb-1 hover:text-white/70 hover:border-white/70 transition-colors">
                    hello@alexdavis.com <ArrowUpRight size={16} />
                 </a>
